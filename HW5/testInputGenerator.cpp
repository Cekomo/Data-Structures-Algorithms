...
// Author      : Hasan Sozer & Gunes Buyukgonenc
// Version     : 4.0
// Update	   : use of steady_clock and default_random_engine instead of srand for randomization
// Copyright   : (c) 2019 Ozyegin University
// Description : Generates test input data for Homework 1, 2, 3 and 4 that is assigned
...
//int main() {
//
//	// this block of code is just to create text file (its name, and the random values..
//	//.. inside) by considering algorithm type, input and k value
//
